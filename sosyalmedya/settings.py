"""
Django settings for sosyalmedya project.
...
SECRET_KEY = 'django-insecure-fkowvt!a@0pxgcy&mb25^#k-5vcd1*njklf07q3wcuec-d@==_'
...
WSGI_APPLICATION = 'sosyalmedya.wsgi.application'
